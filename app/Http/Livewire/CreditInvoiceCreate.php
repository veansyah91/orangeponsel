...
class CreditInvoiceCreate extends Component
{
    public $partnerId;
    ...
    public $searchType, $showTypeSearch, $type, $productId, $stockId, $jumlahUnit, $tanggal, $password, $email;
    ...
    public function render()
    {
        ...
        return view('livewire.credit-invoice-create', [
    ...
    public function store()
    {
        ...
        // buat nota
        $createInvoice = CreditInvoice::create([
